<template>
  ...
  <div :class="'flex flex-wrap justify-center sm:justify-between items-center text-sm w-full'">
    <div v-for="(tab, i) in props.configs.tabs" :key="i" @click="toggleTab(i)"
      class="sm:grow flex flex-row justify-center items-center gap-2 px-8 py-4 cursor-pointer hover:bg-blue-50 dark:hover:bg-zinc-800 border-t-2 border-transparent"
      :class="{
        'text-blue-600 border-t-2 sm:border-t-0 sm:border-b-2 border-t-blue-600 sm:border-b-blue-600': activeTab === i,
